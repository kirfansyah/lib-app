...
$sql = "SELECT * FROM member_perpus ORDER BY id_member DESC";
...
while ($row = $result->fetch_assoc()) {
    ...
    $actions     = ' <a class="me-3 edit-data" href="#" id="edit-data" data-id="' . $row['id_member'] . '" data-bs-toggle="modal" data-bs-target="#create">
                    <img src="assets/img/icons/edit.svg" alt="img">
                    </a>
                    <a class="confirm-text delete-data" href="#" id="delete-data" data-id="' . $row['id_member'] . '">
