...
<div class="page-wrapper pagehead">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a id="add" href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#create"><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Add Kategori</a>
            </div>
        </div>
        <!-- isi content -->
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="nama_kategori" id="nama_kategori" type="text" class="form-control w-300" required autocomplete="off">
                                        <input name="id_kategori" id="id_kategori" type="hidden" class="form-control w-300" required autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12">
                                    <div class="form-group">
        ...
        <script>
            ...
            $(document).on('click', '.btn-submit', function() {
                ...
                $('#user-data input, #user-data select').each(function() {
                    if (($(this).val().trim() === '' || $(this).val() === '-Choose-') && $(this).attr('name') != 'id_kategori') {
                        isValid = false;
            ...
            $(document).on('click', '.edit-data', function(e) {
                ...
                $.ajax({
                    url: "get-kategori-by-id", // Pastikan path sudah benar
                    type: "POST",
                    data: {
                        id_kategori: id
                    },
            ...
            function addData(formData) {
                $.ajax({
                    url: "add-kategori", // Pastikan path sudah benar
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
            ...
            function updateData(formData) {
                $.ajax({
                    url: "update-kategori", // Pastikan path sudah benar
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
            ...
            $(document).on('change', '#name', function() {
                if ($('.btn-submit').attr('action') == 'add') {
                    ...
                    $('#username').val(name[0].toUpperCase())
